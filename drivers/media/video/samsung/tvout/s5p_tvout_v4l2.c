...
/* This block will be used on EXYNOS4 */
	{
		.index		= 2,
		.type		= V4L2_BUF_TYPE_PRIVATE,
...
/*		s5ptv_status.hdmi.hdcp_en = (unsigned int) arg; */
	...
	case VIDIOC_G_VP_BUFF_INFO: {
		struct s5ptv_vp_buf_info *buff_info = (struct s5ptv_vp_buf_info *)arg;
		buff_info->buff_size = S5PTV_VP_BUFF_SIZE;
		buff_info->buff_cnt = S5PTV_VP_BUFF_CNT;
		buff_info->phy_base = s5ptv_vp_buff.vp_buffs[0].phy_base;
		goto end_tvif_ioctl;
	}
	default:
		break;
